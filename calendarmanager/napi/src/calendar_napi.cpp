...
napi_value CalendarNapi::AddEvent(napi_env env, napi_callback_info info)
{
    ...
    auto execute = [ctxt]() {
        ...
        Native::ReportHiEventManager::GetInstance().OnApiCallEnd("AddEvent", result.is_ok(), beginTime);
...
napi_value CalendarNapi::AddEvents(napi_env env, napi_callback_info info)
{
    ...
    auto execute = [ctxt]() {
        ...
        Native::ReportHiEventManager::GetInstance().OnApiCallEnd("AddEvents", result.is_ok(), beginTime);
