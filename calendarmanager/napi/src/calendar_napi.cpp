...
void GetEventsInput(napi_env env, std::shared_ptr<GetEventsContext> ctxt, size_t argc, napi_value* argv)
{
...
void GetEventsExecute(std::shared_ptr<GetEventsContext> ctxt)
{
...
void GetEventsOutput(napi_env env, std::shared_ptr<GetEventsContext> ctxt, napi_value& result)
{
...
napi_value CalendarNapi::GetEvents(napi_env env, napi_callback_info info)
{
    ...
    auto input = [env, ctxt](size_t argc, napi_value* argv) {
        GetEventsInput(env, ctxt, argc, argv);
    };
    ctxt->GetCbInfo(env, info, input);
    auto execute = [ctxt]() {
        GetEventsExecute(ctxt);
    };
    auto output = [env, ctxt](napi_value& result) {
        GetEventsOutput(env, ctxt, result);
    };
