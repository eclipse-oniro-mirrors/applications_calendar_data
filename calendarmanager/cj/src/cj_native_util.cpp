...
std::vector<std::shared_ptr<CJNativeCalendar>> ResultSetToCalendars(DataShareResultSetPtr &resultSet)
{
    std::vector<std::shared_ptr<CJNativeCalendar>> result;
    int rowCount = 0;
    ...
    do {
        ...
        result.emplace_back(std::make_shared<CJNativeCalendar>(curAccount, idValue));
