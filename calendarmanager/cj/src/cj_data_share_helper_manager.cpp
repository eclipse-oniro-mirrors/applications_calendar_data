...
void CJDataShareHelperManager::SetDataShareHelper(std::shared_ptr<DataShare::DataShareHelper> helper)
{
...
bool CJDataShareHelperManager::DestroyDataShareHelper()
{
    std::lock_guard<std::recursive_mutex> lock(dataShareLock);
...
void CJDataShareHelperManager::SetDataShareHelperTimer(int milliseconds)
{
...
std::shared_ptr<DataShare::DataShareHelper> CJDataShareHelperManager::GetDataShareHelper()
{
    return CreateDataShareHelper();
}

int CJDataShareHelperManager::Insert(const Uri &uri, const DataShareValuesBucket &value)
{
...
int CJDataShareHelperManager::BatchInsert(const Uri &uri, const std::vector<DataShare::DataShareValuesBucket> &values)
{
    auto dataShareHelper = CreateDataShareHelper();
    if (!dataShareHelper) {
...
int CJDataShareHelperManager::Update(
...
int CJDataShareHelperManager::Delete(const Uri &uri, const DataSharePredicates &predicates)
{
    auto dataShareHelper = CreateDataShareHelper();
    if (!dataShareHelper) {
...
std::shared_ptr<DataShareResultSet> CJDataShareHelperManager::Query(const Uri &uri, const DataSharePredicates &predicates,
